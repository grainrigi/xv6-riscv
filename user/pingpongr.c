...
int main(int argc, char *argv[]) {
    ...
    unsigned long start_tick = clock();
    ...
    unsigned long end_tick = clock();
    unsigned long elapsed = (end_tick - start_tick) * 1000000 / CLOCKS_PER_SEC;
    printf("total time in %d rounds: %d us\n", n, (int)elapsed);
    exit(0);
}
